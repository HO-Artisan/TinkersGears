...
import ho.artisan.tgears.client.ponder.scene.TinkerMachineScene;
...
public final class TGPonderScenes {
    ...
    public static void register(PonderSceneRegistrationHelper<ResourceLocation> helper) {
        ...
        //.addStoryBoard("basic_melter_pipe", MelterScene::pipe, AllPonderTags.SMELTERY)
        //.addStoryBoard("basic_melter_spout", MelterScene::spout, AllPonderTags.SMELTERY);

        //helper.forComponents(TinkerSmeltery.smelteryController.getId(), TinkerSmeltery.searedDrain.getId(), TinkerSmeltery.searedDuct.getId(), TinkerSmeltery.searedChute.getId())
        ...
        //.addStoryBoard("smeltery_transfer", SmelteryScene::transfer, AllPonderTags.SMELTERY);

        //helper.forComponents(TinkerSmeltery.foundryController.getId(), TinkerSmeltery.scorchedDrain.getId(), TinkerSmeltery.scorchedDuct.getId(), TinkerSmeltery.scorchedChute.getId())
        //.addStoryBoard("foundry_new", ScorchedPonder::basic, TGPonderTags.SMELTERY);

        //helper.forComponents(TinkerSmeltery.searedTable.getId(), TinkerSmeltery.scorchedTable.getId(), TinkerSmeltery.searedBasin.getId(), TinkerSmeltery.scorchedBasin.getId())
        ...
        //.addStoryBoard("table_cooling", CastingScene::table, AllPonderTags.SMELTERY);
