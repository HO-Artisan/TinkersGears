...
public class TinkerFortuneCrushingWheelBlock extends AbstractTinkerCrushingWheelBlock<TinkerCrushingWheelBlockEntity> {

    public TinkerFortuneCrushingWheelBlock(Properties properties) {
        super(properties);
    }

    @Override
    public Supplier<? extends AbstractTinkerCrushingWheelControllerBlock<?>> getControllerBlock() {
        return TGBlocks.TINKER_FORTUNE_CRUSHING_WHEEL_CONTROLLER;
    }
    ...
    public BlockEntityType<? extends TinkerCrushingWheelBlockEntity> getBlockEntityType() {
        return TGBlockEntityTypes.TINKER_FORTUNE_CRUSHING_WHEEL.get();
    }
}
