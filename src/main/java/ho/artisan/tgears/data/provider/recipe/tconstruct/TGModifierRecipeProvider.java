...
public final class TGModifierRecipeProvider extends TGRecipeProvider {
    ...
    private void abilityRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ModifierRecipeBuilder.modifier(TGModifiers.Ids.WRENCH)
                .addInput(AllItems.WRENCH)
                .exactLevel(1)
                .setSlots(SlotType.ABILITY, 1)
                .setTools(TinkerTags.Items.HELD)
                .disallowCrystal()
                .save(consumer, location(folder + "wrench"));
