...
public class TinkerFanRenderer extends KineticBlockEntityRenderer<TinkerFanBlockEntity> {
    public TinkerFanRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void renderSafe(TinkerFanBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
        ...
        SuperByteBuffer fanInner =
                CachedBuffers.partialFacing(TGPartialModels.COBALT_FAN, be.getBlockState(), direction.getOpposite());
